    ...
    <div>
        ...
        <div class="d-flex">
            <div class="list-group menu-esquerda">
                ...
                <router-link class="list-group-item list-group-item-action" :to="{name: 'servicosHome'}" exact-active-class="active"><i class="bi bi-card-checklist" ></i> Serviços </router-link>
            </div>
...
/* .router-link-active {
    color: #fff !important;
    background-color: #889bb9 !important;
    border-color: #889bb9 !important;
} */
